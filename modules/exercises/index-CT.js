...
const averages = require('./ScoreCalcs/averages-CT');       //Import functions from averages.js.
const printAll = require('./display-CT');                   //Import function from display.js.
const randomSelect = require('./randomSelect-CT');          //Import function from randomSelect.js.
