...
function askForNumber() {
  numMealsInput = input.question("How many meals would you like to make? ");
  let numMeals = Number(numMealsInput);
  
  /// CODE YOUR SOLUTION TO PART B here ///
  while (numMeals < 1 || numMeals > 6 || isNaN(numMeals)) {
    numMealsInput = input.question("Invalid Input. Please enter how many meals would you like to make? ");
    numMeals = Number(numMealsInput);
  }
